...
<html>
    ...
    <body>
        ...
        <div class="selection">
            <a class="button" href="policeviewupdate.php?q=<?php echo $login_user; ?>">
                VIEW AND UPDATE MY DETAILS
            </a>
            
            <a class="button" href="opencomplaint.php?q=<?php echo $login_user; ?>">
                VIEW ALL OPEN COMPLAINTS
            </a>
            
            <a class="button" href="mycomplaints.php?q=<?php echo $login_user; ?>">
               VIEW MY COMPLAINTS 
            </a>
